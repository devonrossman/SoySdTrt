...
a<-as.data.frame(summary(lsm1))
a12<-subset(a, !(a$lsmeans.var=="3") & !(a$lsmeans.var=="4"))

g<-ggplot(a12, aes(y=lsmeans.lsmean, x=lsmeans.var, color=lsmeans.sdtrt)
)+
  geom_point()+
   geom_errorbar(aes( ymin=(a12$lsmeans.lsmean-1.96*a12$lsmeans.SE), ymax=(a12$lsmeans.lsmean+1.96*a12$lsmeans.SE), width=0.2))+
...
geom_point()+ 
geom_errorbar(aes(ymin=agh$lsmean-1.96*agh$SE, ymax=agh$lsmean+1.96*agh$SE), width=0.2)+
...
a<-summary(lsm1)
a<-as.data.frame(a)
a13<-subset(a, !(a$lsmeans.var=="3") & !(a$lsmeans.var=="4"))

grdw<-ggplot(a13, aes(y=lsmeans.lsmean, x=lsmeans.var, color=lsmeans.sdtrt)
)+
  geom_point()+
   geom_errorbar(aes( ymin=a13$lsmeans.lsmean-1.96*a13$lsmeans.SE, ymax=a13$lsmeans.lsmean+1.96*a13$lsmeans.SE), width=0.2)+
...
geom_errorbar(aes( ymin=a$lsmean-1.96*a$SE, ymax=a$lsmean+1.96*a$SE), width=0.2)+
