...
D$PD<-scale(D$PD)
D$West<-scale(D$West)
mprob <- glmer(N ~ soycost + West + SOM + Low5wk + sdtrt + var + (1 | location) + (1 | rep/location) + (1 | Year), data=D, family=binomial)
mprob2 <- glmer(N ~ soycost + West + SOM + sdtrt + var + (1 | location) + (1 | rep/location) + (1 | Year), data=D, family=binomial)
summary (mprob)
summary(mprob2)
BIC(mprob)
BIC(mprob2)
